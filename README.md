# Olá sou Kauan Santos e seja bem-vindo ao meu repositório!

- sobre mim 👨‍💻 :
  Sou um jovem iniciante na programação buscando crescer profissionalmente como desenvolvedor full-stack.

- Estudando no momento 📘:
  Atualmente focando no lado Back-end, iniciando pela lógica que está me dando a base e estrutura necessária para entrar em uma linguagem de programação.
